  ...
  return (
    <div className="w-[1200px] max-w-full mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-12">
      <div className="content">
        <motion.div
          className="top mb-8 md:mb-12 flex flex-col md:flex-row justify-between items-start md:items-end border-b border-theme-border pb-6 gap-4 md:gap-0"
        ...
        >
          ...
          <div className="right flex items-center gap-3 w-full md:w-auto">
            <motion.div
              className="hidden md:flex items-center gap-2 text-theme-text-secondary bg-theme-bg-secondary/50 px-3 py-1.5 rounded-lg border border-theme-border"
              whileHover={{
                scale: 1.05,
